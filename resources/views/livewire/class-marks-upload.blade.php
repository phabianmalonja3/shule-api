<div>
    <div class="card-body">
        ...
        <form wire:submit.prevent="uploadMarks">
            ...
            <input wire:model="stream_id" value="{{ $stream_id }}" hidden />
            ...
            <div class="mb-3 d-flex">
                <!-- Upload Button -->
                <button type="submit" class="mx-2 btn btn-primary" wire:click="uploadMarks"
                    wire:loading.attr="disabled">
                    <i class="fa fa-upload"></i> Upload Class Marks
                            ...
                            @foreach ($exam_uploads as $index => $upload)
                                <tr>
                                    ...
                                    <td> {{ $upload->examinationType->name }}
                                        @foreach($months as $key => $month) 
                                            @if($key == $upload->month) ({{ $month }}) @endif
                                        @endforeach
                                    </td>                                                   
                                    ...
                                    <td>
                                        <div
                                            ...
                                            <a href="{{ route('marks.index', ['class_result_flag' => $upload->schoolClass->id.'/'.$upload->examinationType->id]) }}"
