                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>Edit Stream Subject Assignment</h4>
                            </div>
                            <div class="card-body">
                                <!-- Success message -->
                                @if(session('success'))
                                ...
                                <!-- Edit Form -->
                                <form
                                    action="{{ route('streamSubjects.update', ['id'=>$streamSubject->id,'classId'=>$class->id]) }}"
                                    method="POST">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="stream_name" class="form-control"
                                            value="{{ $streams->firstWhere('id', $streamSubject->stream_id)->name ?? 'N/A' }}"
                                            readonly>
                                        <input type="hidden" name="stream_id" value="{{ $streamSubject->stream_id }}">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="subject_id" class="form-control" required>
                                            ...
                                            <option value="{{ $subject->id }}" {{ $subject->id ==
                                                $streamSubject->subject_id ? 'selected' : '' }}>
                                                {{ $subject->name }}
                                            </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="teacher_id" class="form-control" required>
                                            ...
                                            <option value="{{ $teacher->id }}" {{ $teacher->id ==
                                                $streamSubject->teacher_id ? 'selected' : '' }}>
                                                {{ $teacher->name }}
                                            </option>
                                            @endforeach
                                        </select>
