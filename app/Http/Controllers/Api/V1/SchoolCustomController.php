...
class SchoolCustomController extends Controller
{
 ...
 */
	...
	public function bfIndex(Request $request){
		return "hinting bfidex method register your view";
    }
	
    public function getApplicationForm(Request $request){
        if($request->get('level') == 2){
            return view('application.parent-details');
        }elseif($request->get('level') == 3){
            return view('application.other-details');
        }
		return view('application.applicant-details');
    }
